...
df_copy = df_berk[['time', 'timeseries-tas-monthly-mean']]
...
train_series = df_copy.loc[(df_copy.index >= '1900-01-01') & (df_copy.index < '2010-01-01'), 'timeseries-tas-monthly' \
                                                                                             '-mean']
test_series = df_copy.loc[(df_copy.index >= '2010-01-01'), 'timeseries-tas-monthly-mean']
...
train_series = train_series.rename(columns={'timeseries-tas-monthly-mean': 'y'})
m.fit(train_series)
...
test_series = train_series.rename(columns={'timeseries-tas-monthly-mean': 'y'})
...
plt.savefig("Prediction_yhat__CRU.png", dpi=300)
